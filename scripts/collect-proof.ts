...
const CHECKS = [
  ...
  { id: "direct", command: "npm run test:direct", passed: /240 passed/i, count: 240, skipped: 0 },
  { id: "integration", command: "npm run test:integration", passed: /35 passed, 1 skipped/i, count: 35, skipped: 1 },
  { id: "root-scripts", command: "npm run test:scripts", passed: /(?:tests|pass)\s+95[\s\S]*(?:pass|fail)\s+(?:95|0)/i, count: 95, skipped: 0 },
  ...
  { id: "frontend-unit", command: "npm --prefix frontend run test", passed: /Tests\s+128 passed \(128\)/i, count: 128, skipped: 0 },
