...
const CHECKS: readonly CheckDefinition[] = [
  ...
  { id: "direct", command: "npm run test:direct", parse: (output) => parsePytestSummary(output, 240, 0) },
  { id: "integration", command: "npm run test:integration", parse: (output) => parsePytestSummary(output, 35, 1) },
